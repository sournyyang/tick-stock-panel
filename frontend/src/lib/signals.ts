...
export const BUILTIN_SIGNAL_DEFINITIONS: BuiltinSignalDefinition[] = [
  ...
  {
    id: 'signal_trial_close_breakout',
    name: '缩量后阳线突破试盘收盘价',
    kind: 'entry',
    category: '量价',
    description: '试盘后完成缩量，随后实体阳线收盘站上试盘线收盘价。',
  },
  {
    id: 'signal_trial_volume_bearish',
    name: '三倍标杆量阴线',
    kind: 'exit',
    category: '量价',
    description: '阴线成交量达到试盘线成交量的三倍，触发卖出。',
  },
  {
    id: 'signal_profit_target',
    name: '收益目标',
    kind: 'exit',
    category: '收益',
    description: '收盘收益率达到策略设定目标，触发卖出。',
  },
  {
    id: 'signal_close_stop_loss',
    name: '收盘止损',
    kind: 'exit',
    category: '收益',
    description: '收盘收益率跌破策略设定止损线，触发卖出。',
  },
  {
    id: 'signal_limit_up',
    name: '涨停',
